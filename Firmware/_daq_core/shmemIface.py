"""
   ...
   Note: Pulled from: https://github.com/krakenrf/krakensdr_doa/blob/main/_sdr/_receiver/shmemIface.py
"""
...
class outShmemIface:
    def __init__(self, shmem_name, shmem_size, drop_mode=False):
        ...
        try:
            ...
            self.logger.info(f"Shared memory does not exist: {shmem_name}_A.  Creating...")
        try:
